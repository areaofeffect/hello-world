...
(function (root, factory) {
   ...
   * Written 2 Oct 2015 by Tom Igoe. For full example: <a href="https://github.com/vanevery/p5.serialport/tree/main/examples/writeExample">Link</a>
   *
   ...
   * @example
   *
   * For full example: <a href="https://github.com/tigoe/p5.serialport/blob/main/examples/twoPortRead/sketch.js">Link</a>
   *
   ...
   * Works with P5 editor as the socket/serial server, version 0.5.5 or later.
   * Written 2 Oct 2015 by Tom Igoe. For full example: <a href="https://github.com/vanevery/p5.serialport/tree/main/examples/readAndAnimate">Link</a>
   *
   * 		function gotData() {
