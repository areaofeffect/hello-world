...
declare namespace __React {
  ...
  interface ComponentElement<P, T extends Component<P, {}>>
  ...
  interface DOMElement<P extends DOMAttributes, T extends Element>
    extends ReactElement<P> {
    type: string;
    ref: Ref<T>;
  }
  ...
  interface ReactHTMLElement<T extends HTMLElement>
    extends DOMElement<HTMLAttributes, T> {}
  ...
  interface HTMLFactory<T extends HTMLElement>
    extends DOMFactory<HTMLAttributes, T> {}
  ...
  //
  // Browser Interfaces
  // https://github.com/nikeee/2048-typescript/blob/main/2048/js/touch.d.ts
  // ----------------------------------------------------------------------
