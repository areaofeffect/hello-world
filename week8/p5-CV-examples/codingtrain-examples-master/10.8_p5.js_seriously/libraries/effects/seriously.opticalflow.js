...
(function (root, factory) {
  ...
  /*
	...
	https://github.com/v002/v002-Optical-Flow/blob/main/v002.GPUHSFlow.frag
  ...
  Seriously.plugin(
    "opticalflow",
    function () {
      var previousFrameBuffer, baseShader;

      return {
        initialize: function (initialize) {
          previousFrameBuffer = new Seriously.util.FrameBuffer(
            this.gl,
            this.width,
            this.height
          );
    ...
    },
    {
      ...
      inputs: {
        ...
        offset: {
          ...
          max: 100,
          description:
            "distance between texel samples for gradient calculation",
        },
      },
