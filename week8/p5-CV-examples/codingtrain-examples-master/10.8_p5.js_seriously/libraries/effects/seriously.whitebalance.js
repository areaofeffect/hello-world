...
(function (root, factory) {
  ...
  /*
	...
	https://github.com/ikaros-project/ikaros/blob/main/Source/Modules/VisionModules/WhiteBalance/WhiteBalance.cc
    ...
    function () {
      ...
      function updateSize(w, h) {
        ...
        while (pyramidBuffers.length < numLevels) {
          ...
          if (i) {
            pyramidBuffers[i - 1].uniforms.source =
              pyramidBuffers[i].fb.texture;
          }
        }
      }
      ...
      return {
        ...
        shader: function (inputs, shaderSource) {
          ...
          if (auto && !pyramidShader) {
            pyramidShader = new Seriously.util.ShaderProgram(
              this.gl,
              shaderSource.vertex,
              [
